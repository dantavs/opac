...
describe('Create Game Deck Use-Case test suite', () => {
    it('should not create a deck if no card was informed', () => {
        const cards = []

        try {
            const gameDeck = new CreateGameDeck(cards)
            fail('it should throw an error!')
        } catch (error) {
            strictEqual(error.message, 'No card was informed!')
        }
    })
    it('should create a game deck', () => {
        ...
        const gameDeck = CreateGameDeck(cards)
